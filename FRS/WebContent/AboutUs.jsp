...
<body>
	...
	<div class="card-header">
		<p>
			...
			next couple of years ER.SRINIVASAN could start his service from
			Trichy to Chennai. In fact, he began competing with railways by
			starting his service at around the same time from Trichy and reaching
			Chennai much earlier than the express trains. Customers enjoyed the
			experience and started preferring XYZ Flights. It is a fact that XYZ
			was one of the firsts to introduce the latest technologies in
			flights. Today it has the latest and most modern fleet of flights,
			including 35 business class high-end luxury cabins. XYZ's sound
			management and pioneering ideas on fleet standardization, flight
			route review and employee training provided a strong base for growth.
		</p>
	</div>
