	...
	<div class="column1">
		...
		<div class="card text-white">
			...
			<form form action="search" method ="post">
				...
				<div class="row">
					<div class="col">
						<input type="submit" class="btn btn-search btn-block" value="Search Flight">
					</div>
				</div>
				</form>
			</div>
...
for(String flightid : flight){
  String query = "select flight_name,flightid,departuretime,"+flightclass+",arrivaltime from frs_tbl_flight where flightid ='"+flightid+"' ";
						...
						<table class="table table-hover">
						    ...
						    <tbody>
						      ...
						      <input type = "text" name = "children" value=<%= children %> hidden>
						        ...
						        <td><input type="submit"  class="btn btn-primary btn-sm" value="book">
						      </tr>
