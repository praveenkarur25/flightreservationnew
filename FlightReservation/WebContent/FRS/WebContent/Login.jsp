			...
			<div class="card-body">
				<form  action="LoginServlet" method="post">
					...
					<div class="form-group">
						<input type="submit" onClick="return Validation()" value="Login" class="btn float-right login_btn" name="Login">
					</div>
				</form>
			</div>
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href="http://localhost:9080/FRS/Register.jsp">Sign Up</a>
				</div>
			</div>
		</div>
	</div>
